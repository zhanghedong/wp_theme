...
<div class="main">
    <div class="full-wrap lotto-list">
        <ul class="clearfix">
            <li class="lotto-item">
                <div class="lotto-wrap">
                    <a href="<?php echo get_template_directory_uri(); ?>/lotto.html" class="sub">
                        <img src="<?php echo get_template_directory_uri(); ?>/resource/lotto-ssc/ssc.png" class="icon">
                        <div class="info">
                            <span class="type">新时时彩</span>
                            <p>2元赢取100000元</p>
                            <p class="grey">每日84期，返奖率59%</p>
                        </div>
                    </a>
                </div>
            </li>
