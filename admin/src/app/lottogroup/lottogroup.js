 ...
 */
angular.module('lottogroup', []).controller('lottogroupCtrl', ['$scope', '$modal', '$log', '$timeout', 'Lottogroup', 'LuckyConfig', 'alertService', function ($scope, $modal, $log, $timeout, lottoGroupModule, luckyConfig, alertService) {
    var process = {}, config = {};
    config = {
        pageSize: 5,
    ...
    process = {
        ...
        goPage: function (page, num) {
            lottoGroupModule.getList({page: page, num: config.pageSize}, function (list, header) {
        ...
        deleteItemInstanceCtrl: function ($scope, $modalInstance, item) {
            ...
            $scope.confirmDeleteItem = function (item) {
                lottoGroupModule.delete({id: item.id}, function () {
